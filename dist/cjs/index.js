...
var getDataProvider = function (opts) {
    ...
    return function (type, resource, params) {
        var fetchType = reactAdmin.sanitizeFetchType(type);
...
var Application = function (props) {
    ...
    return (React.createElement(reactAdmin.Admin, __assign({}, adminProps), resources === null || resources === void 0 ? void 0 : resources.map(function (resource) {
        return React.createElement(reactAdmin.Resource, __assign({ key: resource.name }, resource));
    })));
};
...
exports.LbProviderGetter = LbProviderGetter;
...
exports.getI18nProvider = getI18nProvider;
